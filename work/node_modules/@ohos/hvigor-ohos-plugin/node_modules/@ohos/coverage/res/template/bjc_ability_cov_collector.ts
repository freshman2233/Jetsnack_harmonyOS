import { AbilityConstant as BjcAbilityConstant, Want as BjcWant } from '@kit.AbilityKit';
class EntryAbility extends UIAbility {
  async onCreate(want: BjcWant, launchParam: BjcAbilityConstant.LaunchParam): Promise<void> {
  ...
  onDump(params: Array<string>): Array<string> {
    const result = super.onDump(params);
    this.__BJC_COV_CollectData();
    return result
  }
