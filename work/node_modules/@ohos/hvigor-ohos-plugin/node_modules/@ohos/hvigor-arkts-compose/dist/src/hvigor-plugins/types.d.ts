...
export interface CompileHookInterface {
    ...
    resolveId?: (this: HvigorCompilePluginContext, source: string, importer: string | undefined, options: {
        attributes: Record<string, string>;
        custom?: {
            [plugin: string]: any;
        };
        isEntry: boolean;
    }) => string | NullValue | false;
    ...
    beforeBuildEnd?: (this: HvigorCompilePluginContext, input?: any) => any;
...
export interface PkgContextInfoOpt {
    ...
    'oh-exports'?: Record<string, string>;
}
export type NullValue = null | undefined | void;
type OrderFunctionType = (order: Record<string, number>) => number;
export {};
