...
import { GetCachedStat } from '../../util/path-cache-stat.js';
...
export declare class ImportResolver {
    ...
    private getInfo;
    constructor(depName2DepInfos: Map<string, DependencyInfoType>, caseSensitiveCheck: boolean, getInfo?: GetCachedStat);
    /**
