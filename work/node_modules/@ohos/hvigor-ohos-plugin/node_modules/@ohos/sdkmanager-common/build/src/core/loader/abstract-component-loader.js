...
class AbstractComponentLoader {
    ...
    isValidComponent(component) {
        ...
        if (!(0, utils_1.isValidApiVersion)(component.getFullApiVersion())) {
    ...
    getLocation(component, sdkRoot) {
        ...
        if ((0, utils_1.isValidApiVersion)(component.getFullApiVersion())) {
            return path_1.default.resolve(sdkRoot, `${component.getFullApiVersion().getValue()}`, this.resolveComponentPath(component.path));
        }
    ...
    genKey(component) {
        if (component.hasApiVersion()) {
            return `${component.getPath()}#${component.getFullApiVersion().getValue()}`;
        }
        else {
