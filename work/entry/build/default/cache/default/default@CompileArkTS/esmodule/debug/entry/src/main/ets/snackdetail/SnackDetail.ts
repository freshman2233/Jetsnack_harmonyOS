...
export class SnackDetailScreen extends ViewPU {
    ...
    initialRender(): void {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777235, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.fontSize(12);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(getColors().textHelp);
            Text.padding({ left: 24, right: 24 });
        ...
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777236, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.fontSize(16);
            Text.fontColor(getColors().textHelp);
        ...
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777242, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.fontSize(12);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(getColors().textHelp);
            Text.padding({ left: 24, right: 24 });
        ...
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777243, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.fontSize(16);
            Text.fontColor(getColors().textHelp);
            Text.padding({ left: 24, right: 24, top: 4 });
        }, Text);
    ...
    CartBar(parent = null): void {
        ...
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel({ "id": 16777220, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
