...
export class CartScreen extends ViewPU {
    ...
    initialRender(): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/home/cart/Cart.ets(74:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("entry/src/main/ets/home/cart/Cart.ets(75:7)", "entry");
            List.width('100%');
            List.height('100%');
            List.padding({ top: 56 });
        }, List);
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("entry/src/main/ets/home/cart/Cart.ets(76:9)", "entry");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(`Order (${this.orderLines.length} ${this.orderLines.length === 1 ? 'item' : 'items'})`);
                    Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(77:11)", "entry");
                    Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                const line = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("entry/src/main/ets/home/cart/Cart.ets(88:11)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
        ...
        ForEach.pop();
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("entry/src/main/ets/home/cart/Cart.ets(93:9)", "entry");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("entry/src/main/ets/home/cart/Cart.ets(97:9)", "entry");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("entry/src/main/ets/home/cart/Cart.ets(105:9)", "entry");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/home/cart/Cart.ets(106:11)", "entry");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/home/cart/Cart.ets(107:13)", "entry");
                    Blank.height(56);
                }, Blank);
                Blank.pop();
                Column.pop();
    ...
    CartItem(line: OrderLine, parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/cart/Cart.ets(126:5)", "entry");
            Column.width('100%');
            Column.onClick(() => this.onSnackClick(line.snack.id, 'cart'));
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/cart/Cart.ets(127:7)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/cart/Cart.ets(136:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/cart/Cart.ets(137:11)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(line.snack.name);
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(138:13)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/home/cart/Cart.ets(145:13)", "entry");
            Stack.width(40);
            Stack.height(40);
            Stack.margin({ top: 12 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(155:11)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/home/cart/Cart.ets(160:11)", "entry");
            Blank.height(8);
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/cart/Cart.ets(162:11)", "entry");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(formatPrice(line.snack.price));
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(163:13)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
    ...
    Summary(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/cart/Cart.ets(194:5)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777250, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(195:7)", "entry");
            Text.fontSize(20);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(getColors().brand);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/cart/Cart.ets(203:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 24, right: 24 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777249, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(204:9)", "entry");
            Text.fontSize(16);
            Text.layoutWeight(1);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(207:9)", "entry");
            Text.fontSize(16);
        }, Text);
        Text.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/cart/Cart.ets(213:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 24, right: 24, top: 8, bottom: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777248, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(214:9)", "entry");
            Text.fontSize(16);
            Text.layoutWeight(1);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(217:9)", "entry");
            Text.fontSize(16);
        }, Text);
        Text.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/home/cart/Cart.ets(223:7)", "entry");
            Blank.height(8);
        }, Blank);
        Blank.pop();
        {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/cart/Cart.ets(226:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 24, right: 24, top: 8, bottom: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777251, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(227:9)", "entry");
            Text.fontSize(16);
            Text.layoutWeight(1);
            Text.margin({ right: 16 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/home/cart/Cart.ets(231:9)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        Text.pop();
    ...
    CheckoutBar(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/cart/Cart.ets(245:5)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/cart/Cart.ets(247:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/home/cart/Cart.ets(248:9)", "entry");
            Blank.layoutWeight(1);
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel({ "id": 16777242, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Button.debugLine("entry/src/main/ets/home/cart/Cart.ets(249:9)", "entry");
