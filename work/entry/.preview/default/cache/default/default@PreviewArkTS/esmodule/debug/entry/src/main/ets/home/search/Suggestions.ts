...
export class SearchSuggestions extends ViewPU {
    ...
    initialRender(): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("entry/src/main/ets/home/search/Suggestions.ets(10:5)", "entry");
            List.width('100%');
            List.height('100%');
        }, List);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                const group = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("entry/src/main/ets/home/search/Suggestions.ets(12:9)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create(group.name);
                            Text.debugLine("entry/src/main/ets/home/search/Suggestions.ets(13:11)", "entry");
                            Text.fontSize(20);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    const forEachItemGenFunction = _item => {
                        const suggestion = _item;
                        {
                            ...
                            const itemCreation2 = (elmtId, isInitialRender) => {
                                ListItem.create(deepRenderFunction, true);
                                ListItem.debugLine("entry/src/main/ets/home/search/Suggestions.ets(23:11)", "entry");
                            };
                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                itemCreation(elmtId, isInitialRender);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create(suggestion);
                                    Text.debugLine("entry/src/main/ets/home/search/Suggestions.ets(24:13)", "entry");
                                    Text.fontSize(16);
                                    Text.fontWeight(FontWeight.Bold);
                ...
                ForEach.pop();
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("entry/src/main/ets/home/search/Suggestions.ets(35:9)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Column.create();
                            Column.debugLine("entry/src/main/ets/home/search/Suggestions.ets(36:11)", "entry");
                        }, Column);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Blank.create();
                            Blank.debugLine("entry/src/main/ets/home/search/Suggestions.ets(37:13)", "entry");
                            Blank.height(4);
                        }, Blank);
                        Blank.pop();
                        Column.pop();
