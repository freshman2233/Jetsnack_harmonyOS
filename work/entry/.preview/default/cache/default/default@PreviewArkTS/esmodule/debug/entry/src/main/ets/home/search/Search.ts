...
export class SearchScreen extends ViewPU {
    ...
    initialRender(): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/search/Search.ets(49:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/search/Search.ets(50:7)", "entry");
            Row.width('100%');
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/home/search/Search.ets(63:9)", "entry");
            ...
            if (this.searching) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("entry/src/main/ets/home/search/Search.ets(81:11)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Blank.create();
                        Blank.debugLine("entry/src/main/ets/home/search/Search.ets(87:11)", "entry");
                        Blank.width(48);
                    }, Blank);
                    Blank.pop();
                });
    ...
    NoResultsView(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/search/Search.ets(123:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/home/search/Search.ets(124:7)", "entry");
            Image.width(200);
            Image.height(105);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`No matches for "${this.query}"`);
            Text.debugLine("entry/src/main/ets/home/search/Search.ets(128:7)", "entry");
            Text.fontSize(16);
        ...
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777283, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/search/Search.ets(135:7)", "entry");
            Text.fontSize(14);
            Text.fontColor(getColors().textSecondary);
            Text.textAlign(TextAlign.Center);
            Text.margin({ top: 16 });
