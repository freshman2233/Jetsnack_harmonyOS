...
export class FilterScreen extends ViewPU {
    ...
    initialRender(): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/home/FilterScreen.ets(23:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/FilterScreen.ets(24:7)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/FilterScreen.ets(30:7)", "entry");
            Column.width('85%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/FilterScreen.ets(31:9)", "entry");
            Row.width('100%');
            Row.padding({ left: 8, right: 16, top: 8, bottom: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/home/FilterScreen.ets(32:11)", "entry");
            Stack.width(40);
            Stack.height(40);
        ...
        Stack.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777266, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/FilterScreen.ets(39:11)", "entry");
            Text.fontSize(20);
        ...
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777279, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/FilterScreen.ets(46:11)", "entry");
            Text.fontSize(14);
        ...
        this.ChipSection.bind(this)({ "id": 16777275, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" }, this.priceFilters);
        this.ChipSection.bind(this)({ "id": 16777252, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" }, this.categoryFilters);
        this.CaloriesSection.bind(this)();
        this.ChipSection.bind(this)({ "id": 16777271, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" }, this.lifeStyleFilters);
        Column.pop();
        Stack.pop();
    }
    SortSection(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/FilterScreen.ets(75:5)", "entry");
            Column.margin({ bottom: 24 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777286, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/FilterScreen.ets(76:7)", "entry");
            Text.fontSize(20);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/home/FilterScreen.ets(83:9)", "entry");
                    Row.width('100%');
                    Row.padding({ top: 14 });
                    Row.onClick(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/home/FilterScreen.ets(87:11)", "entry");
                    Text.fontSize(16);
                    Text.fontWeight(FontWeight.Bold);
                    Text.fontColor(getColors().textSecondary);
                    Text.layoutWeight(1);
    ...
    ChipSection(title: Resource, filters: Filter[], parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/FilterScreen.ets(109:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/home/FilterScreen.ets(110:7)", "entry");
            Text.fontSize(20);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(getColors().brand);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/home/FilterScreen.ets(116:7)", "entry");
            Flex.width('100%');
    ...
    CaloriesSection(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/home/FilterScreen.ets(128:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/home/FilterScreen.ets(129:7)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777272, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/FilterScreen.ets(130:9)", "entry");
            Text.fontSize(20);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(getColors().brand);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777274, "type": 10003, params: [], "bundleName": "com.example.jetsnack", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/home/FilterScreen.ets(134:9)", "entry");
            Text.fontSize(14);
            Text.fontColor(getColors().brand);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Slider.debugLine("entry/src/main/ets/home/FilterScreen.ets(140:7)", "entry");
            Slider.width('100%');
